...
class MenuFrame(tk.Frame):
    ...
    def change_menu(self, option):
        #Destroy previous Option Frame to remove all buttons
        self.option.destroy()
        
        #Create new Option Frame
        self.option = OptionFrame(self)
        self.option.grid(row=1, column=2, columnspan=2, rowspan=4, padx=20, sticky="new")
        self.option.grid_propagate(False)
        
        #Select menu option based on button selection
        match option:
            case 0:
...
class OptionFrame(tk.Frame):
    def __init__(self, parent):
        super().__init__(parent, background="gray", height=460, width=370)
        
    def drink_menu(self):
        self.soft_drink_btn = tk.Button(self, text="Soft Drinks", width=5, height=5)
        self.soft_drink_btn.grid(padx=20, pady=10, row=0, column=0, sticky="new")
        self.bottled_beer_btn = tk.Button(self, text="Bottled\nBeer", width=5, height=5)
        self.bottled_beer_btn.grid(padx=20, pady=10, row=0, column=1, sticky="new")
        self.draft_beer_btn = tk.Button(self, text="Draft\nBeer", width=5, height=5)
        self.draft_beer_btn.grid(padx=20, pady=10, row=0, column=2, sticky="new")
        self.special_btn = tk.Button(self, text="Brewery\nSpecials", width=5, height=5)
        self.special_btn.grid(padx=20, pady=10, row=1, column=0, sticky="new")
        self.mixed_drinks_btn = tk.Button(self, text="Mixed\nDrinks", width=5, height=5)
        self.mixed_drinks_btn.grid(padx=20, pady=10, row=1, column=1, sticky="new")
        
    def appetizer_menu(self):
        self.garlic_toast_btn = tk.Button(self, text="Garlic\nToast", width=5, height=5)
        self.garlic_toast_btn.grid(padx=20, pady=10, row=0, column=0, sticky="new")
        self.breadstick_btn = tk.Button(self, text="Breadsticks", width=5, height=5)
        self.breadstick_btn.grid(padx=20, pady=10, row=0, column=1, sticky="new")
        self.mozzarella_stick_btn = tk.Button(self, text="Mozzarella\nSticks", width=5, height=5)
        self.mozzarella_stick_btn.grid(padx=20, pady=10, row=0, column=2, sticky="new")
        self.grilled_cheese_btn = tk.Button(self, text="Grilled\nCheese", width=5, height=5)
        self.grilled_cheese_btn.grid(padx=20, pady=10, row=1, column=0, sticky="new")
        self.bruschetta_btn = tk.Button(self, text="Bruschetta", width=5, height=5)
        self.bruschetta_btn.grid(padx=20, pady=10, row=1, column=1, sticky="new")
        self.wings_btn = tk.Button(self, text="Boneless\nWings", width=5, height=5)
        self.wings_btn.grid(padx=20, pady=10, row=1, column=2, sticky="new")
        self.popper_toast_btn = tk.Button(self, text="Popper\nToast", width=5, height=5)
        self.popper_toast_btn.grid(padx=20, pady=10, row=2, column=0, sticky="new")
        self.jalapeno_popper_btn = tk.Button(self, text="Jalapeno\nPopper", width=5, height=5)
        self.jalapeno_popper_btn.grid(padx=20, pady=10, row=2, column=1, sticky="new")
    
    def sandwich_menu(self):
        self.stromboli_btn = tk.Button(self, text="Stromboli", width=5, height=5)
        self.stromboli_btn.grid(padx=20, pady=10, row=0, column=0, sticky="new")
        self.veggie_strom_btn = tk.Button(self, text="Veggie\nStromboli", width=5, height=5)
        self.veggie_strom_btn.grid(padx=20, pady=10, row=0, column=1, sticky="new")
        self.ham_n_ch_btn = tk.Button(self, text="Ham and\nCheese", width=5, height=5)
        self.ham_n_ch_btn.grid(padx=20, pady=10, row=0, column=2, sticky="new")
        self.spcy_chkn_btn = tk.Button(self, text="Spicy\nStrom", width=5, height=5)
        self.spcy_chkn_btn.grid(padx=20, pady=10, row=1, column=0, sticky="new")
        self.vinny_btn = tk.Button(self, text="Vinny\nBurger", width=5, height=5)
        self.vinny_btn.grid(padx=20, pady=10, row=1, column=1, sticky="new")
        self.steak_btn = tk.Button(self, text="Chargrilled\nSteak", width=5, height=5)
        self.steak_btn.grid(padx=20, pady=10, row=1, column=2, sticky="new")
        
    def salad_menu(self):
        self.italian_btn = tk.Button(self, text="Italian\nSalad", width=5, height=5)
        self.italian_btn.grid(padx=20, pady=10, row=0, column=0, sticky="new")
        self.spinach_btn = tk.Button(self, text="Spinach\nSalad", width=5, height=5)
        self.spinach_btn.grid(padx=20, pady=10, row=0, column=1, sticky="new")
        self.house_btn = tk.Button(self, text="House\nSalad", width=5, height=5)
        self.house_btn.grid(padx=20, pady=10, row=0, column=2, sticky="new")
        self.greek_btn = tk.Button(self, text="Greek\nSalad", width=5, height=5)
        self.greek_btn.grid(padx=20, pady=10, row=1, column=0, sticky="new")
        
    def pizza_menu(self):
        self.house_spcl_btn = tk.Button(self, text="House\nSpecial", width=5, height=5)
        self.house_spcl_btn.grid(padx=20, pady=10, row=0, column=0, sticky="new")
        self.strom_pie_btn = tk.Button(self, text="Stromboli\nPie", width=5, height=5)
        self.strom_pie_btn.grid(padx=20, pady=10, row=0, column=1, sticky="new")
        self.marg_btn = tk.Button(self, text="Queen\nMargarita", width=5, height=5)
        self.marg_btn.grid(padx=20, pady=10, row=0, column=2, sticky="new")
        self.hawaiian_btn = tk.Button(self, text="Hawaiian\nDelight", width=5, height=5)
        self.hawaiian_btn.grid(padx=20, pady=10, row=1, column=0, sticky="new")
        self.vinny_btn = tk.Button(self, text="Vinny\nBurger", width=5, height=5)
        self.vinny_btn.grid(padx=20, pady=10, row=1, column=1, sticky="new")
        self.iron_btn = tk.Button(self, text="Iron\nMan", width=5, height=5)
        self.iron_btn.grid(padx=20, pady=10, row=1, column=2, sticky="new")
        self.greek_btn = tk.Button(self, text="Greek", width=5, height=5)
        self.greek_btn.grid(padx=20, pady=10, row=2, column=0, sticky="new")
        self.veggie_btn = tk.Button(self, text="Veggie\nSpecial", width=5, height=5)
        self.veggie_btn.grid(padx=20, pady=10, row=2, column=1, sticky="new")
        self.meat_btn = tk.Button(self, text="Lots a\nMeat", width=5, height=5)
        self.meat_btn.grid(padx=20, pady=10, row=2, column=2, sticky="new")
        self.pepper_btn = tk.Button(self, text="Pepper\nPlanet", width=5, height=5)
        self.pepper_btn.grid(padx=20, pady=10, row=3, column=0, sticky="new")
        self.buffalo_btn = tk.Button(self, text="Buffalo\nChicken", width=5, height=5)
        self.buffalo_btn.grid(padx=20, pady=10, row=3, column=1, sticky="new")
        self.bbq_btn = tk.Button(self, text="BBQ", width=5, height=5)
        self.bbq_btn.grid(padx=20, pady=10, row=3, column=2, sticky="new")
        
    def dessert_menu(self):
        self.cookies_btn = tk.Button(self, text="Cookies", width=5, height=5)
        self.cookies_btn.grid(padx=20, pady=10, row=0, column=0, sticky="new")
